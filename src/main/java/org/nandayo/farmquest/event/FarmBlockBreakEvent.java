...
public class FarmBlockBreakEvent extends Event implements Cancellable {
    ...
    public FarmBlockBreakEvent(@NotNull Farmer farmer, @NotNull Block block, @NotNull BlockData blockData, @NotNull FarmBlock farmBlock, @NotNull Farm farm, @NotNull QuestProgress questProgress) {
        this.farmer = farmer;
        this.block = block;
